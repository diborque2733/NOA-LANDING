...
export function TeamV2() {
  return (
    <SectionShell id="team" tone="white">
      {/* Headline sin "founder–market fit por diseño" */}
      <SectionHeader
        eyebrow={TEAM_V2.eyebrow}
        headline={
          <>
            Diecinueve años en minería. Diez en <em>diseño espacial</em> europeo.
          </>
        }
        subline={TEAM_V2.description}
      />
